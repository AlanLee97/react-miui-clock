      ...
      <div className="ringtone-selector">
        <div onClick={() => onClick(0)} className={setClassName(['select-box-wrapper', activeIndex === 0 ? 'select-box-wrapper-active' : ''])}>
          <div className="select-box weather-box">
            <div className="icon-wrapper">
              <svg t="1682930312942" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="14496" width="32" height="32">
                <path d="M906.752 438.784c-124.928 0-226.304-101.376-226.304-226.304 0-24.576 4.096-48.64 11.264-71.168-102.4 21.504-179.712 112.64-179.712 221.184 0 124.928 101.376 226.304 226.304 226.304 100.352 0 184.832-65.024 214.528-155.136-14.336 3.584-29.696 5.12-46.08 5.12z" fill="#EDA915" p-id="14497" />
                <path d="M854.016 664.576c0-94.208-80.896-171.008-180.224-171.008s-180.224 76.288-180.224 171.008v171.008H675.84c98.816-1.024 178.176-77.312 178.176-171.008z" fill="#EAEAEA" p-id="14498" />
                <path d="M740.864 656.384c0-54.272-24.576-102.912-62.976-136.192 0.512-5.12 1.024-10.24 1.024-15.36 0-98.816-80.896-179.2-180.224-179.2s-180.224 80.384-180.224 179.2c0 1.536 0 3.584 0.512 5.12-22.528-11.264-48.128-17.408-74.752-17.408-94.72 0-171.52 76.8-171.52 171.52 0 92.672 73.728 167.936 165.888 171.008v0.512H568.32v-0.512c95.744-4.096 172.544-82.432 172.544-178.688z" fill="#F7F7F7" p-id="14499" />
              </svg>
            </div>
        ...
        <div onClick={() => onClick(2)} className={setClassName(['select-box-wrapper', activeIndex === 2 ? 'select-box-wrapper-active' : ''])}>
          <div className="select-box more-box">
            <div className="icon-wrapper">
              <svg t="1682930575739" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="19068" width="32" height="32">
                <path d="M130.264557 870.035707a122.453333 160 68.891 1 0 298.527032-115.245873 122.453333 160 68.891 1 0-298.527032 115.245873Z" fill="#ffffff" opacity=".99" p-id="19069" />
                <path d="M591.0825 774.046673a122.453333 160 68.891 1 0 298.527032-115.245872 122.453333 160 68.891 1 0-298.527032 115.245872Z" fill="#ffffff" opacity=".99" p-id="19070" />
            ...
            <div className="box-bottom">
              ...
              <div className="small-icon-wrapper">
                <svg t="1682930678863" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="26058" width="12" height="16"><path d="M731.733333 480l-384-341.333333c-17.066667-14.933333-44.8-14.933333-59.733333 4.266666-14.933333 17.066667-14.933333 44.8 4.266667 59.733334L640 512 292.266667 821.333333c-17.066667 14.933333-19.2 42.666667-4.266667 59.733334 8.533333 8.533333 19.2 14.933333 32 14.933333 10.666667 0 19.2-4.266667 27.733333-10.666667l384-341.333333c8.533333-8.533333 14.933333-19.2 14.933334-32s-4.266667-23.466667-14.933334-32z" fill="#ffffff" p-id="26059" /></svg>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="setting-item-wrapper">
        <div className="setting-item">
          ...
          <div className="setting-item-content">
            只响一次
            <div className="icon-wrapper">
              <svg t="1682930678863" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="26058" width="18" height="24"><path d="M731.733333 480l-384-341.333333c-17.066667-14.933333-44.8-14.933333-59.733333 4.266666-14.933333 17.066667-14.933333 44.8 4.266667 59.733334L640 512 292.266667 821.333333c-17.066667 14.933333-19.2 42.666667-4.266667 59.733334 8.533333 8.533333 19.2 14.933333 32 14.933333 10.666667 0 19.2-4.266667 27.733333-10.666667l384-341.333333c8.533333-8.533333 14.933333-19.2 14.933334-32s-4.266667-23.466667-14.933334-32z" fill="#00000066" p-id="26059" /></svg>
            </div>
          </div>
        </div>
        <div className="setting-item">
